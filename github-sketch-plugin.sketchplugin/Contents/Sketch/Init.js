...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/commands/Init.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony default export */ __webpack_exports__["default"] = (function (context) {
  ...
  Object(_common__WEBPACK_IMPORTED_MODULE_1__["executeSafely"])(context, function () {
    var currentFileName = Object(_common__WEBPACK_IMPORTED_MODULE_1__["getCurrentFileName"])(context);

    if (currentFileName) {
      Object(_analytics__WEBPACK_IMPORTED_MODULE_0__["sendEvent"])(context, 'Init', 'Start init');
      var command = "git init && git add \"".concat(currentFileName, "\"");
      var message = Object(_common__WEBPACK_IMPORTED_MODULE_1__["exec"])(context, command);
      context.document.showMessage(message);
      var remoteURL = Object(_common__WEBPACK_IMPORTED_MODULE_1__["createInput"])(context, 'URL of the remote repo (you can create one here: https://github.com/new)', 'Add remote', 'Not now');

      if (remoteURL.responseCode == 1000 && remoteURL.message != null) {
        Object(_analytics__WEBPACK_IMPORTED_MODULE_0__["sendEvent"])(context, 'Init', 'Add remote');
        command = "git remote add origin ".concat(remoteURL.message, "; exit");
        message = Object(_common__WEBPACK_IMPORTED_MODULE_1__["exec"])(context, command);
        context.document.showMessage(message.split('\n').join(' '));
      } else {
        Object(_analytics__WEBPACK_IMPORTED_MODULE_0__["sendEvent"])(context, 'Init', 'Cancel add remote');
      }
    } else {
      Object(_common__WEBPACK_IMPORTED_MODULE_1__["createFailAlert"])(context, 'Failed...', 'Cannot get the current file name');
    }
  });
});
