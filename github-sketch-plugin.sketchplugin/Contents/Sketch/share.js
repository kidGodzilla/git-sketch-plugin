...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/commands/share.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _preferences__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../preferences */ "./src/preferences.js");
...
/* harmony default export */ __webpack_exports__["default"] = (function (context) {
  ...
  Object(_common__WEBPACK_IMPORTED_MODULE_1__["executeSafely"])(context, function () {
    Object(_analytics__WEBPACK_IMPORTED_MODULE_0__["sendEvent"])(context, 'Commit', 'Start commiting');
    var currentBranch = Object(_common__WEBPACK_IMPORTED_MODULE_1__["getCurrentBranch"])(context);
    var prefs = Object(_preferences__WEBPACK_IMPORTED_MODULE_2__["getUserPreferences"])(context);
    var commitMsg = Object(_common__WEBPACK_IMPORTED_MODULE_1__["createInputWithCheckbox"])(context, 'What did you change?', 'Generate files for pretty diffs', prefs.diffByDefault, 'Share');

    if (commitMsg.responseCode == 1000 && commitMsg.message != null) {
      if (commitMsg.checked) {
        Object(_analytics__WEBPACK_IMPORTED_MODULE_0__["sendEvent"])(context, 'Commit', 'Export artboards');
        Object(_common__WEBPACK_IMPORTED_MODULE_1__["exportArtboards"])(context, prefs);
      }

      Object(_analytics__WEBPACK_IMPORTED_MODULE_0__["sendEvent"])(context, 'Commit', 'Do commit');
      var command = "git commit -m \"".concat(commitMsg.message.split('"').join('\\"'), "\" -a; exit");
      var message = Object(_common__WEBPACK_IMPORTED_MODULE_1__["exec"])(context, command);
      context.document.showMessage(message.split('\n').join(' '));
    }
  }); // Push

  Object(_common__WEBPACK_IMPORTED_MODULE_1__["executeSafely"])(context, function () {
    Object(_analytics__WEBPACK_IMPORTED_MODULE_0__["sendEvent"])(context, 'Push', 'Push to remote');
    Object(_common__WEBPACK_IMPORTED_MODULE_1__["exec"])(context, 'git -c push.default=current push -q');
    Object(_common__WEBPACK_IMPORTED_MODULE_1__["exec"])(context, './generate-sketch-files.command');
    context.document.showMessage('Changes pushed. Re-opening sketch file.');
    Object(_common__WEBPACK_IMPORTED_MODULE_1__["reloadCurrentSketchDocument"])(context);
  });
});
