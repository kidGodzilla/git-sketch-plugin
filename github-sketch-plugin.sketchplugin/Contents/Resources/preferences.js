...
function (_Component) {
  ...
  _createClass(Portal, [{
    ...
    value: function renderLayer() {
      ...
      var into = this.props.into || 'body'; // clean up old node if moving bases:

      if (into !== this.intoPointer) {
        this.intoPointer = into;

        if (this.into && this.remote) {
          this.remote = Object(preact__WEBPACK_IMPORTED_MODULE_0__["render"])(React.createElement(PortalProxy, null), this.into, this.remote);
        }

        this.into = this.findNode(into);
      }

      this.remote = Object(preact__WEBPACK_IMPORTED_MODULE_0__["render"])(React.createElement(PortalProxy, {
  ...
  return Portal;
}(preact__WEBPACK_IMPORTED_MODULE_0__["Component"]); // high-order component that renders its first child if it exists.
...
/* harmony import */ var preact__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! preact */ "./node_modules/preact/dist/preact.js");
/* harmony import */ var preact__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(preact__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Portal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Portal */ "./Resources/Portal.js");
...
function (_Component) {
  ...
  function Preferences(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Preferences).call(this, props));
    _this.state = {
  ...
  _createClass(Preferences, [{
    ...
    value: function render(props, _ref) {
      ...
      return React.createElement("div", null, React.createElement(_Portal__WEBPACK_IMPORTED_MODULE_1__["default"], null, React.createElement("button", {
        onClick: function onClick() {
          return sketch_module_web_view_client__WEBPACK_IMPORTED_MODULE_2___default()('savePreferences', preferences);
        },
        className: "save"
      }, "Save Preferences")), !ready && 'loading...', React.createElement("h2", null, "Diffs preferences"), React.createElement("div", {
        className: "form"
      }, React.createElement("label", {
        htmlFor: "folder"
      }, "Folder where the pretty diffs will be exported"), React.createElement("input", {
        type: "text",
        value: preferences.exportFolder,
        id: "folder",
        onInput: this.linkState('preferences.exportFolder')
      })), React.createElement("div", {
        className: "form"
      }, React.createElement("label", {
        htmlFor: "scale"
      }, "Scale of the exported artboards"), React.createElement("input", {
        type: "number",
        value: preferences.exportScale,
        id: "scale",
        onInput: this.linkState('preferences.exportScale')
      })), React.createElement("div", {
        className: "form"
      }, React.createElement("label", {
        htmlFor: "format"
      }, "Format of the exported artboards"), React.createElement("select", {
        id: "form",
        value: preferences.exportFormat,
        onChange: this.linkState('preferences.exportFormat')
      }, React.createElement("option", {
        value: "png"
      }, "PNG"), React.createElement("option", {
        value: "jpg"
      }, "JPG"), React.createElement("option", {
        value: "pdf"
      }, "PDF"), React.createElement("option", {
        value: "eps"
      }, "EPS"), React.createElement("option", {
        value: "svg"
        ...
        id: "diffByDefault",
        onChange: this.linkState('preferences.diffByDefault')
      }), React.createElement("label", {
        htmlFor: "diffByDefault"
      }, " Generate pretty diff by default")), React.createElement("div", {
        className: "form"
      }, React.createElement("input", {
        type: "checkbox",
        checked: preferences.includeOverviewFile,
        id: "includeOverviewFile",
        onChange: this.linkState('preferences.includeOverviewFile')
      }), React.createElement("label", {
        htmlFor: "includeOverviewFile"
      }, " Save an overview file with rendered artboards")), React.createElement("div", {
        className: "form"
      }, React.createElement("input", {
        type: "checkbox",
        checked: preferences.autoExportOnSave,
        id: "autoExportOnSave",
        onChange: this.linkState('preferences.autoExportOnSave')
      }), React.createElement("label", {
        htmlFor: "autoExportOnSave"
      }, " Auto export artboards on save")), React.createElement("h2", null, "Miscellaneous"), React.createElement("div", {
        className: "form"
      }, React.createElement("label", {
        htmlFor: "terminal"
      }, "Terminal App"), React.createElement("select", {
        id: "terminal",
        value: preferences.terminal,
        onChange: this.linkState('preferences.terminal')
      }, React.createElement("option", {
        value: "Terminal"
      }, "Terminal"), React.createElement("option", {
        value: "iTerm"
      }, "iTerm"))), React.createElement("div", {
        className: "form"
      }, React.createElement("input", {
        type: "checkbox",
        checked: preferences.sendAnalytics,
        id: "sendAnalytics",
        onChange: this.linkState('preferences.sendAnalytics')
      }), React.createElement("label", {
        htmlFor: "sendAnalytics"
      }, " Send anymous usage data to improve the plugin")));
    }
  }]);
...
Object(preact__WEBPACK_IMPORTED_MODULE_0__["render"])(React.createElement(Preferences, null), document.getElementById('container'));
