...
// Check for update
var getManifestVersion = __webpack_require__(8)
var getNewestVersion = __webpack_require__(9)
var getReleaseNotes = __webpack_require__(10)
...
var _sketchModuleGoogleAnalytics = __webpack_require__(7);
...
var _sketchModuleUpdate = __webpack_require__(2);

var _sketchModuleUpdate2 = _interopRequireDefault(_sketchModuleUpdate);

var _common = __webpack_require__(0);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var repoFullName = 'mathieudutour/git-sketch-plugin';

var options = {
  title: 'A new Git plugin version is available!',
  customizeAlert: _common.setIconForAlert
};

exports.default = (0, _sketchModuleUpdate2.default)(repoFullName, options);
...
var _sketchModuleUserPreferences = __webpack_require__(11);

var _sketchModuleUserPreferences2 = _interopRequireDefault(_sketchModuleUserPreferences);

var _sketchModuleFs = __webpack_require__(6);
...
module.exports = function getNewestVersionNumber(repo) {
  var url = NSURL.URLWithString('https://raw.githubusercontent.com/' + repo + '/master/package.json')
