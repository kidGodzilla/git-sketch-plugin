...
exports.default = function (context) {
  ...
  (0, _common.executeSafely)(context, function () {
    (0, _analytics.sendEvent)(context, 'Commit', 'Start commiting');
    var currentBranch = (0, _common.getCurrentBranch)(context);
    var prefs = (0, _preferences.getUserPreferences)(context);
    var commitMsg = (0, _common.createInputWithCheckbox)(context, 'Commit to "' + currentBranch + '"', 'Generate files for pretty diffs', prefs.diffByDefault, 'Commit');

    if (commitMsg.responseCode == 1000 && commitMsg.message != null) {
      if (commitMsg.checked) {
        (0, _analytics.sendEvent)(context, 'Commit', 'Export artboards');
        (0, _common.exportArtboards)(context, prefs);
      }
      (0, _analytics.sendEvent)(context, 'Commit', 'Do commit');
