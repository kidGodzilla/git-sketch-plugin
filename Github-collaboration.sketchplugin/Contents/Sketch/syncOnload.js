...
var _preferences = __webpack_require__(6);
...
exports.default = function (context) {
  ...
  (0, _sketchModuleSettimeoutPolyfill.setTimeout)(function () {
    context.document.showMessage('Checking for updates..');
    log('starting');

    if (!(0, _common.checkForGitRepository)(context)) {
      return;
    }
...
var _sketchModuleSettimeoutPolyfill = __webpack_require__(3);

module.exports = exports['default']; // Pull
