...
var _sketchModuleGoogleAnalytics = __webpack_require__(8);
...
exports.default = function (context) {
  ...
  (0, _common.executeSafely)(context, function () {
    (0, _analytics.sendEvent)(context, 'Branch', 'Switch branch', 'Start switching branch');
    var listBranchesCommand = 'git for-each-ref --format=\'%(refname:short)\' refs/heads/';
    var listBranches = (0, _common.exec)(context, listBranchesCommand);
    if (listBranches != null && listBranches != '') {
      listBranches = listBranches.split('\n');
      listBranches.pop(); // last item is always an empty string
      var currentBranch = (0, _common.getCurrentBranch)(context);
      var webUI = new _sketchModuleWebView2.default(context, 'branches.html', {
        ...
        handlers: {
          checkoutBranch: function checkoutBranch(name) {
            (0, _common.executeSafely)(context, function () {
              (0, _analytics.sendEvent)(context, 'Branch', 'Switch branch', 'Did switch branch');
          ...
          deleteBranch: function deleteBranch(name) {
            (0, _common.executeSafely)(context, function () {
              (0, _analytics.sendEvent)(context, 'Branch', 'Delete branch', 'Did delete branch');
          ...
          createBranch: function createBranch() {
            (0, _common.executeSafely)(context, function () {
              (0, _analytics.sendEvent)(context, 'Branch', 'Create branch', 'Start creating branch');
              var branchName = (0, _common.createInput)(context, 'New branch name', 'Create branch');
              ...
              if (branchName.responseCode == 1000 && branchName.message != null) {
                ...
                (0, _analytics.sendEvent)(context, 'Branch', 'Create branch', 'Did create branch');
                webUI.panel.close();
              } else {
                (0, _analytics.sendEvent)(context, 'Branch', 'Create branch', 'Cancel creating branch');
              }
            });
          }
        }
      ...
      (0, _analytics.sendEvent)(context, 'Branch', 'Switch branch', 'no branches');
...
var _sketchModuleUserPreferences = __webpack_require__(9);

var _sketchModuleUserPreferences2 = _interopRequireDefault(_sketchModuleUserPreferences);

var _sketchModuleFs = __webpack_require__(7);
