...
exports.default = function (context) {
  var preferences = (0, _preferences.getUserPreferences)(context);
    ...
    handlers: {
      savePreferences: function savePreferences(prefs) {
        (0, _common.executeSafely)(context, function () {
          (0, _analytics.sendEvent)(context, 'Preferences', 'Save preferences');
          (0, _preferences.setUserPreferences)(context, prefs);
          webUI.panel.close();
...
module.exports = exports['default']; // Commits all working file to git (cmd alt ctrl c)
