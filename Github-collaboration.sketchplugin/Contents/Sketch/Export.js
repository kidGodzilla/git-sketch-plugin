...
exports.default = function (context) {
  if (!(0, _common.checkForFile)(context) && !(0, _common.checkForGitRepository)(context)) {
    return;
  }
  (0, _common.executeSafely)(context, function () {
    (0, _analytics.sendEvent)(context, 'Manual Export', 'Do export');
    (0, _common.exportArtboards)(context, (0, _preferences.getUserPreferences)(context));
